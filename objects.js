...
product.price = 999;
console.log("Update on object", product);

// 4️⃣ D – Delete (Remove property)
// 👉 Delete product.details.specs.ram.
delete product.details.specs.ram;
console.log("Delete on object", product);
...
console.log(
  ...
  ", City of cartCopy : ",
  cartCopy.customer.address.city
);
...
console.log(
  "name in product now change to productName but value is still",
  productName,
  "while stock is still",
  stock,
  "because it's placed inside the Object."
);
...
console.log("Brand is:", brand, "CPU is:", cpu);

/* Below this is a solution for a guideline
("use strict");
